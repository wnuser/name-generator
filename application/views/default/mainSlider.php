...
<li class="breadcrumb-item"><a href="#!">Insert Main Slider</a>
</li>
<li class="breadcrumb-item">
<a href="<?= base_url('admin/allmainslider') ?> ">View All</a>
</li>
</ul>
</div>
</div>
...
<h5>Main Slider Content form</h5>
<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>
</div>
<div class="card-block">
<form id="main" method="post" enctype="multipart/form-data" action="<?= base_url('admin/insertmainslider') ?> " novalidate>
