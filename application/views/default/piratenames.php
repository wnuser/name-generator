                                            ...
                                            <?php if($this->session->flashdata('success')) {
                                                 ...
                                                 <form action="<?=base_url('UploadCsv/index')?>" enctype="multipart/form-data" method="POST">
                                                     <div class="form-group row">
                                                          ...
                                                          <input type="hidden" name="table" value="pirateNames">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="<?= base_url('InsertController/insertData') ?>" novalidate>
                                                            <input type="hidden" value="pirateNames" name="table">
                                                            <?php   $current_url = current_url(); 
                                                                    $arr = explode('/', $current_url);
                                                                    $url = $arr['4']; 
                                                            ?>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Adjective that describe the personality </label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Enter a Related place  </label>
                                                                <div class="col-sm-10">
