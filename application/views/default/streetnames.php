                                            ...
                                            <?php if($this->session->flashdata('success')) {
                                                 ...
                                                 <form action="<?=base_url('UploadCsv/index')?>" enctype="multipart/form-data" method="POST">
                                                     <div class="form-group row">
                                                          ...
                                                          (name)
                                                          <input type="hidden" name="table" value="Streetnames">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="<?= base_url('InsertController/insertData') ?>" novalidate>
                                                            <input type="hidden" value="Streetnames" name="table">
                                                            <?php   $current_url = current_url(); 
                                                                    $arr = explode('/', $current_url);
                                                                    $url = $arr['4']; 
                                                            ?>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">How unusual would you like them to be?</label>
                                                                <div class="col-sm-10">
                                                                    <select name="likethem" class="form-control" id="">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Begin with </label>
                                                                <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="password" name="beginwith" placeholder="">

                                                                    <span class="messages"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">End with </label>
                                                                <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="password" name="endwith" placeholder="">
