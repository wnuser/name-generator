                                            ...
                                            <?php if($this->session->flashdata('success')) {
                                                 ...
                                                 <form action="<?=base_url('UploadCsv/index')?>" enctype="multipart/form-data" method="POST">
                                                     <div class="form-group row">
                                                          ...
                                                          (name, size, color )
                                                          <input type="hidden" name="table" value="houseNames">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="<?= base_url('InsertController/insertData') ?>" novalidate>
                                                            <input type="hidden" value="houseNames" name="table">
                                                            <?php   $current_url = current_url(); 
                                                                    $arr = explode('/', $current_url);
                                                                    $url = $arr['4']; 
                                                            ?>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">How would you describe the house's location?</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">How big is the house?</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">color of House</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="password" name="street" placeholder="">
