                                            ...
                                            <?php if($this->session->flashdata('success')) {
                                                 ...
                                                 <form action="<?=base_url('UploadCsv/index')?>" enctype="multipart/form-data" method="POST">
                                                     <div class="form-group row">
                                                          ...
                                                          (name, gender, country, religion )
                                                          <input type="hidden" name="table" value="firstNames">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="<?= base_url('InsertController/insertData') ?>" novalidate>
                                                            <input type="hidden" value="firstNames" name="table">
                                                            <?php   $current_url = current_url(); 
                                                                    $arr = explode('/', $current_url);
                                                                    $url = $arr['4']; 
                                                            ?>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="password" name="surname" placeholder="">
