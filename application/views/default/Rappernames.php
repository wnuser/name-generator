                                            ...
                                            <?php if($this->session->flashdata('success')) {
                                                 ...
                                                 <form action="<?=base_url('UploadCsv/index')?>" enctype="multipart/form-data" method="POST">
                                                     <div class="form-group row">
                                                          ...
                                                          (name, adjective )
                                                          <input type="hidden" name="table" value="rapperNames">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="<?= base_url('InsertController/insertData') ?>" novalidate>
                                                            <input type="hidden" value="rapperNames" name="table">
                                                            <?php   $current_url = current_url(); 
                                                                    $arr = explode('/', $current_url);
                                                                    $url = $arr['4']; 
                                                            ?>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Favourate TV character  </label>
                                                                <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="password" name="ftvcharchacter" placeholder="Favourate TV character">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">An Adjective that exactly describe your personality ?</label>
                                                                <div class="col-sm-10">
