                                            ...
                                            <?php if($this->session->flashdata('success')) {
                                                 ...
                                                 <form action="<?=base_url('UploadCsv/index')?>" enctype="multipart/form-data" method="POST">
                                                     <div class="form-group row">
                                                          ...
                                                          (name, color, adjective , group )
                                                          <input type="hidden" name="table" value="teamNames">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="<?= base_url('InsertController/insertData') ?>" novalidate>
                                                            <input type="hidden" value="teamNames" name="table">
                                                            <?php   $current_url = current_url(); 
                                                                    $arr = explode('/', $current_url);
                                                                    $url = $arr['4']; 
                                                            ?>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">A color </label>
                                                                <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="password" name="color" placeholder="">
                                                                    <span class="messages"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">An adjective </label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">A Place </label>
                                                                <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="password" name="place" placeholder="">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Any animal   </label>
                                                                <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="password" name="animal" placeholder="">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">group of people </label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="password" name="group" placeholder="Enter  Name">
                                                                    <span class="messages"></span>
                                                                </div>
                                                            </div>
