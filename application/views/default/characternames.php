                                            ...
                                            <?php if($this->session->flashdata('success')) {
                                                 ...
                                                 <form action="<?=base_url('UploadCsv/index')?>" enctype="multipart/form-data" method="POST">
                                                     <div class="form-group row">
                                                          ...
                                                          (name, gender, country, flavour, characters )
                                                          <input type="hidden" name="table" value="charactersName">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="<?= base_url('InsertController/insertData') ?>" novalidate>
                                                            <input type="hidden" value="charactersName" name="table">
                                                            <?php   $current_url = current_url(); 
                                                                    $arr = explode('/', $current_url);
                                                                    $url = $arr['4']; 
                                                            ?>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Select Flavour</label>
                                                                <div class="col-sm-10">
                                                                    <select name="flavour" id="" class="form-control">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Select Character Title</label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Select Character Type She/He</label>
                                                                <div class="col-sm-10">
                                                                    <select name="characters" id="" class="form-control">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" id="password" name="name" placeholder="name">
                                                                    <span class="messages"></span>
                                                                </div>
                                                            </div>
