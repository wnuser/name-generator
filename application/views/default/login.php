   ...
   <body themebg-pattern="theme1">
      ...
      <section class="login-block">
         <div class="container-fluid">
            <div class="row">
               <div class="col-sm-12">
                  <form class="md-float-material form-material" method="post" action="<?= base_url('Auth/Cheakauth') ?>">
                     ...
                     <div class="auth-box card">
                        <div class="card-block">
                           ...
                           <div class="form-group form-primary">
                              <input type="text" name="user-name" class="form-control" required="required" >
                           ...
                           <div class="row m-t-25 text-left">
                              <div class="col-12">
                                 <div class="forgot-phone text-right float-right">
                                    <a href="<?= base_url('Auth/reset') ?>" class="text-right f-w-600"> Forgot Password?</a>
                                 </div>
                              </div>
                           </div>
                        ...
                        <?php if( $Invalid=  $this->session->flashdata('Invalid')){
                           ?>
                        <div class="alert alert-danger">
                           <?= $Invalid ?> <button class="btn btn-default" data-dismiss="alert">x</button>
                        </div>
                        <?php
                           } ?>
                     </div>
