...
<head>
    <title>Middle Name Generator | NameGenerator-Engine.com</title>
    <meta name="description" content="Middle Name Generator. Generate 100000's of perfect middle names either for your baby or yourself with a single click."/>
	<meta name="keywords" content=""/>
    <meta property="og:title" content="Middle Name Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Middle Name Generator. Generate 100000's of perfect middle names either for your baby or yourself with a single click"/>
    <meta property="og:url" content="https://namegenerator-engine.com/middle-name-generator"/>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center ">
                            <h1>Middle Name Generator</h1>
                            <h2>Generate The Middle  Names Within A Click</h2>
                            <p>NameGenerator-Engine's Middle Name Generator is here to help you find the perfect middle names. Search by the gender, surname, and birth year.</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-lg-4 col-md-4 col-12 mb-4">
                            <div class="white-box">
                              ...
                              <button type="button" class="btn btn-custom mb-2" onclick="fillAll()" id="fill_all">fill Randomly</button>
                                ...
                                <form action="<?= base_url('Middlename/getNames') ?>" name="form" method="post">
                                    <div class="row">
