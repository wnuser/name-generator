...
<html>
<head>
	<title>Username Generator | NameGenerator-Engine.com</title>
	<meta name="description" content="Username Generator. Generate 100000's of cool usernames with a single click. Find strong Facebook, Twitter, Youtube, Instagram usernames & more."/>
	<meta name="keywords" content=""/>
    <meta property="og:title" content="Username Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Username Generator. Generate 100000's of cool usernames with a single click. Find strong Facebook, Twitter, Youtube, Instagram usernames & more."/>
    <meta property="og:url" content="https://namegenerator-engine.com/user-name-generator"/>
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
            ...
            <h2>Generate The User Names Within A Click</h2>
         </div>
      </div>
   </div>
</section>
     ...
     <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12 mb-4">
                <div class="white-box">
                   <h4>Fill the Form</h4>
                   <button type="button" class="btn pb-2 btn-custom" onclick="fillAll()" id="fill_all">fill Randomly</button>
                   <form action="<?= base_url('Usersname/getNames') ?>" method="post" name="form">
                   <div class="row">
                       ...
                       <div class="col-12 mb-4">
                         <label>Middle Name</label>
                          <div class="input-group mb-3">
                            <input type="text" name="middlename" class="gr-input">
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('firstname', 'middlename')">Suggest</button>
                            </div>
                          </div>
                       </div>
                       <div class="col-12 mb-4">
             ...
             <div class="col-lg-4 col-md-4 col-12 mb-4">
                ...
                <h4>Result</h4>
                    ...
                    <?php 
                     if($data) {
                        if($data['stringArray']) {
                           foreach ($data['stringArray'] as $key => $value) {
                               foreach ($value as $key => $valuee) {
                                  # code...
                                  echo "<p>".$valuee['name']."</pre>";                            }
                               }
                           }
                     }
                   ...
                   <?php 
                     ...
                     if($data) {
                        ...
                        if($data['superArray']){
                           foreach($data['superArray'] as $key => $value){
                                  foreach ($value as $key => $valuee) {
                                     # code...
                                     echo "<p>".$valuee['name']."</pre>";                            }
                                  }
