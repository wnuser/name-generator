...
<head>
    <title>Last Name Generator | NameGenerator-Engine.com</title>
    <meta name="description" content="Last Name Generator. Generate 100000's of last male & female names with a single click. A great collection of countrywise last names."/>
    <meta name="keywords" content=""/>
    <meta property="og:title" content="Last Name Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Last Name Generator. Generate 100000's of last male & female names with a single click. A great collection of countrywise last names."/>
    <meta property="og:url" content="https://namegenerator-engine.com/last-name-generator"/>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center ">
                            ...
                            <h2>Generate The Last  Names Within A Click</h2>
                            <p>Generate 100000's of last male & female names with a single click with NameGenerator-Engine's Last Name Generator tool. A great collection of countrywise last names.</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-lg-4 col-md-4 col-12 mb-4">
                            <div class="white-box">
                              ...
                              <button type="button" class="btn btn-custom mb-2" onclick="fillAll()" id="fill_all">fill Randomly</button>
                                ...
                                <form action="<?= base_url('Lastname/getNames') ?>" name="form" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-4">
                                            <label for="">What kind of Character</label>
                                            <select name="typeofcharcter" class="form-control select">
