...
<html>
<head>
	<title>City Name Generator | NameGenerator-Engine.com</title>
	<meta name="description" content="City name generator. 100000's of town and fictional city name ideas are available with a single click. A one stop place name generator for your next story."/>
	<meta name="keywords" content=""/>
    <meta property="og:title" content="City Name Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="City name generator. 100000's of town and fictional city name ideas are available with a single click. A one stop place name generator for your next story."/>
    <meta property="og:url" content="https://namegenerator-engine.com/city-name-generator"/>
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
            ...
            <h2>Generate The City & Town Names Within A Click</h2>
            <p>Generate the real and fictional city names easily with the help of NameGenerator-Engine's City Name Generator. 100000's of town and fictional city name ideas are available with a single click.</p>
         </div>
      </div>
   </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-12 mb-4">
                <div class="white-box">
                   ...
                   <form action="<?= base_url('Cityname/getNames') ?>" method="post" name="form">
                   <div class="row">
