...
<html>
<head>
	<title>Random Food Generator | NameGenerator-Engine.com</title>
	<meta name="description" content="Random Food Generator. Generate 1000's of random food names in starters, main meals, puddings, snacks for breakfast, lunch, dinner & restaurants."/>
    <meta name="keywords" content=""/>
    <meta property="og:title" content="Random Food Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Random Food Generator. Generate 1000's of random food names in starters, main meals, puddings, snacks for breakfast, lunch, dinner & restaurants."/>
    <meta property="og:url" content="https://namegenerator-engine.com/food-name-generator"/>
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
            ...
            <h2>Generate Random Food Names Within A Click</h2>
            <p>Generate 1000's of random food names in starters, main meals, puddings, snacks for breakfast, lunch, dinner & restaurants with the help of NameGenerator-Engine's Random Food Generator tool.</p>
         </div>
      </div>
   </div>
</section>
            ...
            <div class="col-lg-4 col-md-4 col-12 mb-4">
                <div class="white-box">
                  ...
                  <button type="button" class="btn btn-custom mb-2" onclick="fillAll()" id="fill_all">fill Randomly</button>
                   <form action="<?= base_url('Foodname/getNames') ?>" name="form" method="post">
                   <div class="row">
                       ...
                       <div class="col-12 mb-4">
                           <label>Type of food you wanna prefer</label>
                              <select class="form-control select" name="typeoffood" id="gender">
                        ...
                        <div class="col-12 mb-4">
                           <label>What kind of Life Style you have?</label>
                              <select class="form-control select" name="lifestyle" id="gender">
