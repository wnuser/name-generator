...
<html>
<head>
	<title>Blog Name Generator | NameGenerator-Engine.com</title>
	<meta name="description" content="Blog Name Generator. 100000's of blog names are available with a single click for Blogger, WordPress, Medium, Tumblr and other blogging platforms."/>
	<meta name="keywords" content=""/>
    <meta property="og:title" content="Blog Name Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Blog Name Generator. 100000's of blog name ideas are available with a single click for Blogger, WordPress, Medium, Tumblr and other blogging platforms."/>
    <meta property="og:url" content="https://namegenerator-engine.com/blog-name-generator"/>
    ...
    function populateSuggestions(){
      ...
      suggestions['adjective']       = new Array('gentle', 'compassionate', 'modest', 'adorable', 'brave', 'helpful','loving', 'special', 'hopeful', 'optimistic', 'charming','kind', 'grateful', 'gracious', 'delightful', 'patient','generous', 'energetic', 'down to earth', 'admirable', 'friendly','smart', 'considerate','noble', 'articulate', 'caring','intuitive', 'sympathetic','clever', 'daring', 'courageous','hilarious', 'understanding', 'incredible','funny', 'popular', 'virtuous', 'lovable', 'remarkable', 'cute', 'sweet', 'splendid','stable', 'witty', 'admirable', 'giving', 'intelligent', 'brave', 'bold'
													             );
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
            ...
            <h2>Generate The Blog Names Within A Click</h2>
            <p>Are you looking to start a blog? Blog name does matter a lot, be it with WordPress, Blogger, Tumblr or other blogging platforms. With NameGenerator-Engine's Blog Name Generator tool you can easily generate the catchy, funny, impressive blog & website name.</p>
         </div>
      </div>
   </div>
</section>
            ...
            <div class="col-lg-4 col-md-4 col-12 mb-4">
                <div class="white-box">
                  ...
                  <button type="button" class="btn btn-custom mb-2" onclick="fillAll()" id="fill_all">fill Randomly</button>
                   <form action="<?= base_url('Blogname/getNames') ?>" name="form" method="post">
                   <div class="row">
                   ...
                   <div class="col-12 mb-4">
                         <label>First Name</label>
                          <div class="input-group mb-3">
                            <input type="text" name="firstname" class="gr-input" required>
                       ...
                       <div class="col-12 mb-4">
                         <label>Your Last Name</label>
                          <div class="input-group mb-3">
                            <input type="text" name="lastname"  class="gr-input" >
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('surname','lastname')">Suggest</button>
                            </div>
                          </div>
                       </div>
                       ...
                       <div class="col-12 mb-4">
                         <label>An Adjective that describe the assense of blog</label>
                          <div class="input-group mb-3">
                       ...
                       <div class="col-12 mb-4">
                         <label>Three verbs that relate to the subject of the blog (e.g. cooking, reading, texting)</label>
                          <div class="input-group mb-3">
                            <input type="text" name="verb_1"  class="gr-input" >
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('verb','verb_1')">Suggest</button>
                            </div>
                          </div>
                          <div class="input-group mb-3">
                            <input type="text" name="verb_2"  class="gr-input" >
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('verb','verb_2')">Suggest</button>
                            </div>
                          </div>
                          <div class="input-group mb-3">
                            <input type="text" name="verb_3"  class="gr-input" >
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('verb','verb_3')">Suggest</button>
                            </div>
                          </div>
                       </div>
