...
<html>
<head>
	<title>Nickname Generator | NameGenerator-Engine.com</title>
	<meta name="description" content="Nickname Generator. Generate 100000's of combinations for girls nicknames and boys nicknames with a single click."/>
    <meta name="keywords" content=""/>
    <meta property="og:title" content="Nickname Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Nickname Generator. Generate 100000's of combinations for girls nicknames and boys nicknames with a single click."/>
    <meta property="og:url" content="https://namegenerator-engine.com/nick-name-generator"/>
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
            ...
            <h2>Generate The Nicknames Within A Click</h2>
            <p>It always has been hard to choose a perfect nickname. NameGenerator-Engine's Nickname Generator helps you generate the nicknames easily.</p>
         </div>
      </div>
   </div>
</section>
        ...
        <div class="row">
           <div class="col-md-4 col-lg-4 col-12">
                <div class="white-box">
                   ...
                   <form action="<?= base_url('Nickname/getNames') ?>" method="post" name="form">
                   <div class="row">
                       ...
                       <div class="col-12 mb-4">
                         <label>Positive Adjective</label>
                          <div class="input-group mb-3">
                            ...
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('adjectives','adjective')">Suggest</button>
                            </div>
                          </div>
                       </div>
