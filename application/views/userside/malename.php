...
<html>
<head>
	<title>Male Name Generator | NameGenerator-Engine.com</title>
	<meta name="description" content="Male Name Generator. Generate 100000's of male names with a single click. Choose your country and generate guy names instantly."/>
	<meta name="keywords" content=""/>
    <meta property="og:title" content="Male Name Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Male Name Generator. Generate 100000's of male names with a single click. Choose your country and generate guy names	
instantly."/>
    <meta property="og:url" content="https://namegenerator-engine.com/male-name-generator"/>
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
             <h1>Male Name Generator</h1>
            <h2>Generate Male Names Within A Click</h2>
            <p>Our Male Name Generator lets you generate 100000's of male names. Choose your country and get an extensive list of countrywise male names.</p>
         </div>
      </div>
   </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12 mb-4">
                <div class="white-box">
                   ...
                   <form action="<?= base_url('Malename/getNames') ?>" name="form" method="post">
                   <div class="row">
