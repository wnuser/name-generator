...
<html>
<head>
    	<title>Street Name Generator | NameGenerator-Engine.com</title>
	<meta name="description" content="Street Name Generator. Generate 100000's of street names with a single click. This is also a road name generator perfect for pathways, alleys, roads & more."/>
	<meta name="keywords" content=""/>
    <meta property="og:title" content="Street Name Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Street Name Generator. Generate 100000's of street names with a single click. This is also a road name generator perfect for pathways, alleys, roads & more."/>
    <meta property="og:url" content="https://namegenerator-engine.com/street-name-generator"/>
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
            <h1>Street Name Generator</h1>
            <h2>Generate The Street Names Within A Click</h2>
            <p>NameGenerator-Engine's Street Name Generator lets you generate 100000's modern street names within seconds. This is also a road name generator perfect for pathways, alleys, roads & more.</p>
         </div>
      </div>
   </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12 mb-4">
                <div class="white-box">
                   ...
                   <form action="<?= base_url('Streetname/getNames') ?>" method="post" name="form">
                   <div class="row">
                       ...
                       <div class="col-12 mb-4">
                        <label>How unusual would you like them to be?</label>
                            <select class="form-control select" name="likethem">
