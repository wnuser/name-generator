...
<html>
<head>
	<title>Couple Name Generator | NameGenerator-Engine.com</title>
	<meta name="description" content="Couple Name Generator. Combine your and your partner's name into a single beautiful couple name with a single click."/>
    <meta name="keywords" content=""/>
    <meta property="og:title" content="Couple Name Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Couple Name Generator. Combine your and your partner's name into a single beautiful couple name with a single click."/>
    <meta property="og:url" content="https://namegenerator-engine.com/couple-name-generator"/>
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
            <h1>Couple Name Generator</h1>
            <h2>Generate The Couple Names Within A Click</h2>
            <p>NameGenerator-Engine's Couple Name Generator allows you to combine your and your loved one name into a unique couple name.</p>
         </div>
      </div>
   </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-12 mb-4">
                <div class="white-box">
                   ...
                   <form action="<?= base_url('Couplename/getNames') ?>" method="post" name="form">
                   <div class="row">
                       ...
                       <div class="col-12 mb-4">
                        <label> <strong> Person A </strong> </label>
                       </div>
                       <div class="col-12 mb-4">
                         <label>First Name</label>
                          <div class="input-group mb-3">
                            <input type="text" name="afname" class="gr-input" >
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('firstname','afname')" >Suggest</button>
                            </div>
                          </div>
                       </div>
                       <div class="col-12 mb-4">
                         <label>Surname Name</label>
                          <div class="input-group mb-3">
                            <input type="text" name="asname" class="gr-input">
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('surname', 'asname')">Suggest</button>
                            </div>
                          </div>
                       </div>
                       <div class="col-12 mb-4">
                        <label> <strong> Person B </strong> </label>
                       </div>
                       <div class="col-12 mb-4">
                         <label>First Name</label>
                          <div class="input-group mb-3">
                            <input type="text" name="bfname" class="gr-input" >
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('firstname','bfname')" >Suggest</button>
                            </div>
                          </div>
                       </div>
                       <div class="col-12 mb-4">
                         <label>Surname Name</label>
                          <div class="input-group mb-3">
                            <input type="text" name="bsname" class="gr-input">
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('surname', 'bsname')">Suggest</button>
                            </div>
                          </div>
                       </div>
