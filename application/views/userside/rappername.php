...
<html>
<head>
	<title>Rap Name Generator | NameGenerator-Engine.com</title>
	<meta name="description" content="Rap Name Generator. Generate rapper names inspired by famous real artists with a single click. Our rap generator delivers you the unique names."/>
	<meta name="keywords" content=""/>
    <meta property="og:title" content="Rap Name Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Rap Name Generator. Generate rapper names inspired by famous real artists with a single click. Our rap generator delivers you the unique names."/>
   ...
   <script>
      function populateSuggestions(){
         ...
         suggestions['birthyear']       = new Array( '1881', '1882', '1883', '1884', '1885', '1886', '1887', '1888', '1889', '1890', '1891', '1892', '1893', '1894', '1895', '1896', '1897', '1898', '1899', '1900', '1901', '1902', '1903', '1904', '1905', '1906', '1907', '1908', '1909', '1910', '1911', '1912', '1913', '1914', '1915', '1916', '1917', '1918', '1919', '1920', '1921', '1922', '1923', '1924', '1925', '1926', '1927', '1928', '1929', '1930', '1931', '1932', '1933', '1934', '1935', '1936', '1937', '1938', '1939', '1940', '1941', '1942', '1943', '1944', '1945', '1946', '1947', '1948', '1949', '1950', '1951', '1952', '1953', '1954', '1955', '1956', '1957', '1958', '1959', '1960', '1961', '1962', '1963', '1964', '1965', '1966', '1967', '1968', '1969', '1970', '1971', '1972', '1973', '1974', '1975', '1976', '1977', '1978', '1979', '1980', '1981', '1982', '1983', '1984', '1985', '1986', '1987', '1988', '1989', '1990', '1991', '1992', '1993', '1994', '1995', '1996', '1997', '1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '1979', '1979', '1980', '1980', '1981', '1981', '1982', '1982', '1983', '1983', '1984', '1984', '1985', '1985', '1986', '1986', '1987', '1987', '1988', '1988', '1989', '1989', '1990', '1990', '1991', '1991', '1992', '1992', '1993', '1993', '1994', '1994', '1995', '1995', '1996', '1996', '1997', '1997', '1998', '1998', '1999', '1999', '2000', '2000', '2001', '2001', '2002', '2002', '2003', '2003', '2004', '2004', '2005', '2005', '2006', '2006', '2007', '2007', '2008', '2008', '2009', '2009', '2010', '2010', '2011', '2011', '2012', '2012', '2013', '2013', '2014', '2014', '2015', '2015', '2016', '2016', '2017', '2017', '1990', '1990', '1991', '1991', '1992', '1992', '1993', '1993', '1994', '1994', '1995', '1995', '1996', '1996', '1997', '1997', '1998', '1998', '1999', '1999', '2000', '2000', '2001', '2001', '2002', '2002', '2003', '2003', '2004', '2004', '2005', '2005', '2006', '2006', '2007', '2007', '2008', '2008', '2009', '2009', '2010', '2010', '2011', '2011', '2012', '2012', '2013', '2013', '2014', '2014', '2015', '2015', '2016', '2016', '1995', '1995', '1996', '1996', '1997', '1997', '1998', '1998', '1999', '1999', '2000', '2000', '2001', '2001', '2002', '2002', '2003', '2003', '2004', '2004', '2005', '2005', '2006', '2006', '2007', '2007', '2008', '2008', '2009', '2009', '2010', '2010', '2011', '2011', '2012', '2012', '2013', '2013', '2014', '2014', '2015', '2015', '1880');			
			...
			suggestions['ftvcharchacter'] = new Array('Mickey Mouse','Kermit the Frog','Miss Piggy','Big Bird','Gonzo','The Fonz','Homer Simpson','Marge Simpson','Bart Simpson','Dale Cooper','Tony Soprano','Fox Mulder','Dana Scully','Eric Cartman','Captain Kirk','Chandler Bing','Gob Bluth','Frasier Crane','Niles Crane','Peppa Pig');	
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
            ...
            <h2>Generate The Rap Names Within A Click</h2>
         </div>
      </div>
   </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12 mb-4">
                <div class="white-box">
                   ...
                   <form action="<?= base_url('Rappername/getNames') ?>" method="post" name="form">
                   <div class="row">
                       ...
                       <input type="hidden">
                       <div class="col-12 mb-4">
                         <label>Your favourite TV character</label>
                          <div class="input-group mb-3">
                            <input type="text" name="ftvcharchacter" class="gr-input" >
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('ftvcharchacter','ftvcharchacter')" >Suggest</button>
                            </div>
                          </div>
                       </div>
                       ...
                       <div class="col-12 mb-4">
                         <label>The name of a criminal</label>
                          <div class="input-group mb-3">
                            <input type="text" name="criminal" class="gr-input" >
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('criminal','criminal')">Suggest</button>
                            </div>
                          </div>
                       </div>

                       <div class="col-12 mb-4">
                         <label>The name of your favourite childhood pet</label>
                          <div class="input-group mb-3">
                            <input type="text" name="name_of_pet" class="gr-input" >
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('name_of_pet','name_of_pet')">Suggest</button>
                            </div>
                          </div>
                       </div>

                       <div class="col-12 mb-4">
                         <label>Something really pleasant (e.g. flowers, kittens)</label>
                          <div class="input-group mb-3">
                            <input type="text" name="pleasant" class="gr-input" >
                            <div class="input-group-append">
                              <button class="btn btn-custom" type="button" onclick="suggest('pleasant','pleasant')">Suggest</button>
                            </div>
                          </div>
                       </div>

                       <div class="col-12 mb-4">
                         <label>An Adjective that exactly describe your personality ?</label>
                          <div class="input-group mb-3">
