...
<html>
<head>
	<title>Female Name Generator | NameGenerator-Engine.com</title>
	<meta name="description" content="Female Name Generator. Generate 100000's of female names with a single click. A great collection of countrywise women names."/>
	<meta name="keywords" content=""/>
    <meta property="og:title" content="Female Name Generator | NameGenerator-Engine.com" />
    <meta property="og:description" content="Female Name Generator. Generate 100000's of female names with a single click. A great collection of countrywise women names."/>
    <meta property="og:url" content="https://namegenerator-engine.com/female-name-generator"/>
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
             <h1>Female Name Generator</h1>
            <h2>Generate Female Names Within A Click</h2>
            <p>Generate 100000's of female names with a single click with NameGenerator-Engine's Female Name Generator. A great collection of countrywise women names.</p>
         </div>
      </div>
   </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12 mb-4">
                <div class="white-box">
                   ...
                   <form action="<?= base_url('Femalename/getNames') ?>" name="form" method="post">
                   <div class="row">
