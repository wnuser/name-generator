...
<html>
<head>
	<title>Fantasy Name Generator | NameGenerator-Engine.com</title>
   ...
   <div class="container">
      <div class="row">
         <div class="col-12 text-center ">
            ...
            <h2>Generate Fantasy Names Within A Click</h2>
            <p>Generate 100000's of male and female fantasy names with NameGenerator-Engine's Fantasy Name Generator with a single click for angel, dragons, aliens, fairies, goblins, unicorns & more.</p>
         </div>
      </div>
   </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12 mb-4">
                <div class="white-box">
                   ...
                   <form action="<?= base_url('Fantasyname/getNames') ?>" name="form" method="post">
                   <div class="row">
                       ...
                       <div class="col-12 mb-4">
                        ...
                        <div class="col-12 mb-4">
                           <label>Which kinds of names would you like to generate?</label>
                              <select class="form-control select" name="typeofname" id="gender">
                                 ...
                                 <option value="Yeties">Yeties</option>
